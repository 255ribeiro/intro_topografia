...
O padrão EPSG atribui códigos únicos a cada sistema de coordenadas, facilitando a troca de dados geográficos entre softwares e sistemas. Por exemplo, o código [EPSG:4326](https://epsg.io/4326) refere-se ao sistema WGS84 geográfico.
...
- **WGS84 Geográfico ([EPSG:4326](https://epsg.io/4326))**: Sistema de coordenadas geográficas baseado no datum World Geodetic System 1984. Usa latitude e longitude em graus decimais. É o padrão para GPS e muitos serviços online como Google Maps.
- **WGS84 / Pseudo-Mercator ([EPSG:3857](https://epsg.io/3857))**: Projeção Mercator modificada, usada em mapas web como Google Maps, OpenStreetMap e Bing Maps. Adequada para visualização global em escalas pequenas a médias.
- **UTM (Universal Transverse Mercator)**: Sistema projetado dividido em zonas de 6° de longitude. Exemplos:
  - UTM Zone 22S ([EPSG:32722](https://epsg.io/32722)): Cobre partes do Brasil meridional.
  - UTM Zone 24S ([EPSG:32724](https://epsg.io/32724)): Cobre partes do nordeste brasileiro, incluindo Bahia.
- **ETRS89 (European Terrestrial Reference System 1989)**: Usado na Europa, com códigos como [EPSG:4258](https://epsg.io/4258) para coordenadas geográficas.
- **NAD83 (North American Datum 1983)**: Usado na América do Norte, com [EPSG:4269](https://epsg.io/4269) para geográficas.
...
- **SIRGAS 2000 / UTM**: Dividido em zonas para cobrir o país:
  - Zona 18S ([EPSG:31978](https://epsg.io/31978)): Norte do país.
  - Zona 19S ([EPSG:31979](https://epsg.io/31979)): Centro-norte.
  - Zona 20S ([EPSG:31980](https://epsg.io/31980)): Centro.
  - Zona 21S ([EPSG:31981](https://epsg.io/31981)): Centro-sul.
  - Zona 22S ([EPSG:31982](https://epsg.io/31982)): Sul.
  - Zona 23S ([EPSG:31983](https://epsg.io/31983)): Extremo sul.
  - Zona 24S ([EPSG:31984](https://epsg.io/31984)): Nordeste, incluindo Bahia.
  - Zona 25S ([EPSG:31985](https://epsg.io/31985)): Leste do Nordeste.

- **SIRGAS 2000 Geográfico ([EPSG:4674](https://epsg.io/4674))**: Para coordenadas globais em latitude/longitude.
...
- **SIRGAS 2000 / UTM Zone 24S ([EPSG:31984](https://epsg.io/31984))**: Adequado para a maioria do estado, com origem no equador e meridiano central em 39°W. Oferece precisão métrica em distâncias locais.
...
- **SIRGAS 2000 / UTM Zone 24S ([EPSG:31984](https://epsg.io/31984))**: Ideal para mapeamento urbano, planejamento municipal e aplicações locais em Salvador.
...
Para Salvador, o sistema SAD69 / UTM Zone 24S ([EPSG:29184](https://epsg.io/29184)) era comumente usado para mapeamento e levantamentos locais. Embora ainda encontrado em dados antigos, o SAD69 apresenta desvios de até 100-200 metros em relação ao SIRGAS 2000, devido a diferenças no datum e elipsoide.
